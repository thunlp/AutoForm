...
2. Concluding with the Answer (Optional): End your response with "Answer: {answer}", where {answer} is the final result of your problem-solving process. The {answer} should be a single capital letter.
3. You can use tools to execute Python code to help you do some calculations. You should not finish the whole problem in the code.
4. Only when you end your response with "Answer: {answer}" will the dialogue end.
"""
