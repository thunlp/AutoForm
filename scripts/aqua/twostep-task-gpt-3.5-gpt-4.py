...
parser.add_argument("--task", type=str, default="tasksolving/aqua/twostep-task-gpt-3.5-gpt-4")
parser.add_argument(
    "--tasks_dir",
    type=str,
    default=os.path.join(os.path.dirname(__file__), "..", "..", "agentverse", "tasks"),
)
parser.add_argument("--dataset_path", type=str, default="data/aqua/test.jsonl")
