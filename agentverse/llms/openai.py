...
from openai_pool import OpenaiPoolRequest
pool = OpenaiPoolRequest('pool.json')
        ...
        try:
            ...
            if functions != []:
                ...
                response = pool.request(
                    messages=messages, functions=functions, **self.args.dict()
                )
